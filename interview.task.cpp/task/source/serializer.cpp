...
namespace Task
{
    void SerializeToFile(const DataWrapper* dataWrapper, const char* filePath)
    {
        ...
        file.write(reinterpret_cast<const char*>(&dataWrapper->version), sizeof(dataWrapper->version));
    ...
    void DeserializeFromFile(DataWrapper*& dataWrapper, const char* filePath)
    {
        ...
        file.read(reinterpret_cast<char*>(&dataWrapper->version), sizeof(dataWrapper->version));
        
        switch(dataWrapper->version) {
            case 1:
